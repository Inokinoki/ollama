...
void rocm_init(char *rocm_lib_path, rocm_init_resp_t *resp) {
  ...
  struct lookup {
    ...
    void **p;
      ...
      {"amdsmi_init", (void *)&resp->rh.rsmi_init},
      {"amdsmi_shut_down", (void *)&resp->rh.rsmi_shut_down},
      {"amdsmi_dev_memory_total_get", (void *)&resp->rh.rsmi_dev_memory_total_get},
      {"amdsmi_dev_memory_usage_get", (void *)&resp->rh.rsmi_dev_memory_usage_get},
      {"amdsmi_version_get", (void *)&resp->rh.rsmi_version_get},
      {"amdsmi_num_monitor_devices", (void*)&resp->rh.rsmi_num_monitor_devices},
      {"amdsmi_dev_id_get", (void*)&resp->rh.rsmi_dev_id_get},
      {"amdsmi_dev_name_get", (void *)&resp->rh.rsmi_dev_name_get},
      {"amdsmi_dev_brand_get", (void *)&resp->rh.rsmi_dev_brand_get},
      {"amdsmi_dev_vendor_name_get", (void *)&resp->rh.rsmi_dev_vendor_name_get},
      {"amdsmi_dev_vram_vendor_get", (void *)&resp->rh.rsmi_dev_vram_vendor_get},
      {"amdsmi_dev_serial_number_get", (void *)&resp->rh.rsmi_dev_serial_number_get},
      {"amdsmi_dev_subsystem_name_get", (void *)&resp->rh.rsmi_dev_subsystem_name_get},
      {"amdsmi_dev_vbios_version_get", (void *)&resp->rh.rsmi_dev_vbios_version_get},
      {NULL, NULL},
  };
